...
parameters.scene;camera=parameters.camera}if(parameters.holoScreenSize==undefined)holoScreenSize=40;else holoScreenSize=parameters.holoScreenSize;if(parameters.holoCamFov==undefined)holoCamFov=50;else holoCamFov=parameters.holoCamFov;nearClip=parameters.nearclip;farClip=parameters.farclip;if(parameters.messageFlag==undefined){messageFlag=0;console.log("parameters.messageFlag not defined!")}else messageFlag=parameters.messageFlag;renderTarget=parameters.renderTarget;forceClear=parameters.forceClear;
